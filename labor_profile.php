...
$sql = "SELECT * FROM regular_users WHERE username = '$username'";
...
if ($result->num_rows > 0) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $update_sql = "UPDATE regular_users SET  contact_number='$contact_number' WHERE username='$username'";
    ...
    if (isset($_POST['delete_account'])) {
        ...
        $delete_sql = "DELETE FROM regular_users WHERE username='$username'";
