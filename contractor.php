...
<body>
    ...
    <div class="container">
        <h2>Want to Hire Labors</h2>
        <p class="black-text">Labor registered on our portal</p>
        ...
        <div class="contractor-list">
            ...
            // Fetch list of lbor from the database
            $result = $mysqli->query("SELECT username, contact_number, labor_address, experience,profession FROM labor_users");
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<p>Address: ' . $row["labor_address"] . '</p>';
    ...
    <div class="profile-menu" id="profileMenu">
        <ul>
            <li><a href="Contractor_profile.php">View Profile</a></li> <!-- Changed link to redirect to labor_profile.php -->
